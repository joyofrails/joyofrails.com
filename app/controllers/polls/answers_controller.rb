  ...
  class AnswersController < ApplicationController
    ...
    def create
      ...
      if @answer.save
        respond_to do |format|
          format.html { redirect_to poll_path(@poll), notice: "Answer was successfully created." }
    ...
    def update
      ...
      if @answer.update(answer_params)
        respond_to do |format|
          format.html { redirect_to poll_path(@poll), notice: "Answer was successfully updated." }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to poll_path(@poll), notice: "Answer was successfully destroyed." }
