  ...
  class QuestionsController < ApplicationController
    ...
    def create
      ...
      if @question.save
        respond_to do |format|
          format.html { redirect_to poll_path(@poll), notice: "Date was successfully created." }
    ...
    def update
      ...
      if @question.update(question_params)
        respond_to do |format|
          format.html { redirect_to poll_path(@poll), notice: "Date was successfully updated." }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to poll_path(@poll), notice: "Date was successfully destroyed." }
