Rails.application.configure do
  ...
  #
  config.x.vapid.public_key = credentials.dig(:vapid, :public_key).to_s.delete("=") # The VAPID public key
  config.x.vapid.private_key = credentials.dig(:vapid, :private_key).to_s.delete("=") # The VAPID private key
